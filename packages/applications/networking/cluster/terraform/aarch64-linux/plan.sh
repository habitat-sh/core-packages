...
pkg_source="https://releases.hashicorp.com/${pkg_name}/${pkg_version}/${pkg_name}_${pkg_version}_linux_arm64.zip"
pkg_filename="${pkg_name}_${pkg_version}_linux_arm64.zip"
pkg_shasum="e9a8a2f676b51a5334d00a0c3695b24ca75e30f4f449eb191e304fedfa099565"

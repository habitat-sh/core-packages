...
$pkg_source="https://archive.apache.org/dist/${pkg_name}/${pkg_name}-3/${pkg_version}/binaries/apache-${pkg_name}-${pkg_version}-bin.zip"
$pkg_shasum="7ebee30817faef009c7352a876616457c718bccc3be57fc3a0182155ce69d360"
$pkg_dirname="apache-$pkg_name-$pkg_version"
$pkg_bin_dirs=@("bin")
$pkg_lib_dirs=@("lib")

function Invoke-Prepare {
    $env:JAVA_HOME = "$(Get-HabPackagePath corretto11)"

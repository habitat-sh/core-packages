...
pkg_shasum="ccf36b53fb0024a017353c3ddb22c1f00bc7a8073c6aac79042da24ee34434d3"
pkg_dirname=go
pkg_deps=(
  core/glibc
)
...
do_prepare() {
  ...
  ln -sv  "$(pkg_path_for glibc)/lib/ld-linux-aarch64.so.1" "/lib/ld-linux-aarch64.so.1"
}

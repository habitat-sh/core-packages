...
$pkg_source="https://github.com/PowerShell/PowerShell/releases/download/v$pkg_version-preview.3/PowerShell-$pkg_version-preview.3-win-x64.zip"
$pkg_shasum="b14c25b408a46639818cd8977bd159b3ef5e4bddd67d359426a24271a14f51b4"
$pkg_filename="powershell-$pkg_version-preview.3-win-x64.zip"
$pkg_bin_dirs=@("bin")
